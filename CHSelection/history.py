...
class History:
    ...
    def save_global_best_fitness_chart(self, title='Global Best Fitness', legend=None, linestyle='-', color='b', x_label="#Iteration",
        ...
        self.visualize.export_convergence_chart(data=self.list_global_best_fit, title=title, legend=legend, linestyle=linestyle,
    ...
    def save_local_best_fitness_chart(self, title='Local Best Fitness', legend=None, linestyle='-', color='b', x_label="#Iteration",
        ...
        self.visualize.export_convergence_chart(self.list_current_best_fit, title=title, legend=legend, linestyle=linestyle, color=color,
    ...
    def save_runtime_chart(self, title='Runtime chart', legend=None, linestyle='-', color='b', x_label="#Iteration",
        ...
        self.visualize.export_convergence_chart(self.list_epoch_time, title=title, legend=legend, linestyle=linestyle, color=color,
                                 x_label=x_label, y_label=y_label, filename=filename, exts=exts, verbose=verbose)
    ...
    def save_exploration_exploitation_chart(self, title="Exploration vs Exploitation Percentages", list_colors=('blue', 'orange'),
        ...
        self.visualize.export_explore_exploit_chart(data=[self.list_exploration, self.list_exploitation], title=title,
    ...
    def save_diversity_chart(self, title='Diversity Measurement Chart', algorithm_name='Algorithm',
        ...
        self.visualize.export_diversity_chart(data=[self.list_diversity], title=title, list_legends=[algorithm_name],
    ...
    def save_global_objectives_chart(self, title='Global Objectives Chart', x_label="#Iteration", y_labels=None,
        ...
        self.visualize.export_objectives_chart(global_obj_list, title=title, x_label=x_label, y_labels=y_labels, filename=filename, verbose=verbose)
    ...
    def save_local_objectives_chart(self, title='Local Objectives Chart', x_label="#Iteration", y_labels=None,
        ...
        self.visualize.export_objectives_chart(current_obj_list, title=title, x_label=x_label, y_labels=y_labels,
                                filename=filename, verbose=verbose)
    ...
    def save_trajectory_chart(self, title="Trajectory of some agents",
        ...
        if n_dim == 1:
            ...
            self.visualize.export_trajectory_chart(pos_list, n_dimensions=n_dim, title=title, list_legends=list_legends,
            ...
            for idx1, id_agent in enumerate(list_agent_idx):
                ...
                list_legends.append(f"Agent {id_agent}")
            self.visualize.export_trajectory_chart(pos_list, n_dimensions=n_dim, title=title, list_legends=list_legends, x_label=x_label,
                                    y_label=y_label, filename=filename, verbose=verbose)